...
layui.define(['layer', 'laytpl', 'upload'], function(exports){
  ...
  var elemChatList = '<li class="layim-{{ d.data.type }}{{ d.data.id }} layim-chatlist-{{ d.data.type }}{{ d.data.id }} layim-this" layim-event="tabChat"><img src="{{ d.data.avatar }}"><span>{{ d.data.name||"佚名" }}</span><i class="layui-icon" layim-event="closeChat">&#x1007;</i></li>';
  ...
  var layimChat, layimMin, chatIndex, To = {}, popchat = function(data){
    ...
    console.log(layimChat, 'layimChat')
    if(chat[0]){
